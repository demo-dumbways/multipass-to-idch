...
## 5.2 Kenapa Harus Reverse Proxy?
...
- Jika sudah sekarang kita akan coba cek apakah konfigurasi yang sudah kita buat itu ada eror atau tidak. Kalian dapat menggunakan perintah di bawah ini
...
- Sekarang kita coba akses web browser kita selanjutnya akses nama domain yang sudah kita buat tadi.
