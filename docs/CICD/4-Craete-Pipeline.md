...
Jenkinsfile merupakan file yang digunakan untuk menjalankan proses pipeline dari CICD, berisi tahapan yang harus diselesaikan. Berikut ini adalah bentuk Jenkinsfile yang akan digunakan
