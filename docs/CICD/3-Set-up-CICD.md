...
Supaya repository jenkins yang telah ditambahkan ke dalam server terbaca, sebaiknya jalankan perintah berikut
...
Untuk mengetahui service jenkins telah berjalan atau belum, jalankan perintah berikut
...
Setelah melakukan instalasi dan reverse proxy, maka kita akan melakukan konfigurasi jenkins. Berikut ini adalah tampilan yang akan muncul jika proses yang telah dilakukan sebelumnya berhasil.

  <center>
  <img alt="image1" src={useBaseUrl('img/docs/cicd-jenkins-4.png')} height="400px"/>
  </center>

Untuk melanjutkan proses konfigurasi jenkins, Kita perlu mengakses server jenkins dan menjalankan perintah berikut untuk melihat password Admin dari Jenkins.
